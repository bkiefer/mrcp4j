 ...
 * an MRCP resource by an {@link org.mrcp4j.client.MrcpChannel} instance.
 * 
 * @author Niels Godfredsen {@literal <}<a href="mailto:ngodfredsen@users.sourceforge.net">ngodfredsen@users.sourceforge.net</a>{@literal >}
 * @see org.mrcp4j.client.MrcpChannel#addEventListener(org.mrcp4j.client.MrcpEventListener) 
 * @see org.mrcp4j.client.MrcpChannel#removeEventListener(org.mrcp4j.client.MrcpEventListener) 
 */
