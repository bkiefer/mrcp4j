...
public class MrcpRequestProcessorImpl implements MrcpRequestProcessor {
    ...
    private static class MrcpSessionImpl implements MrcpSession {
        ...
        /* (non-Javadoc)
         * @see org.mrcp4j.server.MrcpSession#createResponse(short, org.mrcp4j.MrcpRequestState)
         */
        ...
        /* (non-Javadoc)
         * @see org.mrcp4j.server.MrcpSession#createEvent(org.mrcp4j.MrcpEventName, org.mrcp4j.MrcpRequestState)
         */
        ...
        /* (non-Javadoc)
         * @see org.mrcp4j.server.MrcpSession#postEvent(org.mrcp4j.message.MrcpEvent)
         */
