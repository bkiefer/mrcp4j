...
///////////////////////////////////////
    ...
    /**
     * org.mrcp4j.message.header.{@link org.mrcp4j.message.header.ChannelIdentifier}
     */
    CHANNEL_IDENTIFIER                  ("Channel-Identifier", new ChannelIdentifier.Factory()),

    /**
     * org.mrcp4j.message.header.{@link org.mrcp4j.message.header.RequestIdList}
     */
    ...
    CONTENT_TRANSFER_ENCODING           ("Content-Transfer-Encoding" /*, TokenList.class*/),
...
///////////////////////////////////////
    ...
    /**
     * org.mrcp4j.message.header.{@link org.mrcp4j.message.header.CompletionCause}
     */
...
///////////////////////////////////////
    ...
    X_NUANCE_MRCP_AUDIO                 ("X-Nuance-Mrcp-Audio"),
    X_NUANCE_END_OF_SPEECHDATA          ("X-Nuance-End-Of-SpeechData"),
...
///////////////////////////////////////
    ...
    public static EnumSet<MrcpHeaderName> RECOG_ONLY_HEADER_NAMES = EnumSet.of(
            ...
            X_NUANCE_MRCP_AUDIO, X_NUANCE_END_OF_SPEECHDATA
    );
    ...
    public static MrcpHeader createHeader(String name, String valueString) {
        ...
        try {
            ...
            return new UnknownHeader(name, (valueString == null) ? "" : valueString.trim());
        }
    ...
    private static class NonNegativeIntegerFactory extends GenericValueFactory {
        ...
        /* (non-Javadoc)
         * @see org.mrcp4j.message.header.GenericValueFactory#validateObject(java.lang.Object)
         */
        @Override
